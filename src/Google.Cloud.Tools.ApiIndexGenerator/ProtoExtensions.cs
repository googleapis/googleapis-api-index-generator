...
// Once Google.Protobuf 3.15.0 is released, a lot of this code can go away, as we'll be able to parse the
// file descriptor with the extensions already present.
